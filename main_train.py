...
from utilities.data_utils import get_loader
...
parser.add_argument("--logdir", default="result", type=str, help="directory to save the tensorboard logs")
...
parser.add_argument("--roi_z", default=160, type=int, help="roi size in z direction")
...
def main_worker(gpu, args):
    ...
    loader = utilities.dataloader.nnDataloader([args.roi_x, args.roi_y, args.roi_z], args.batch_size,
                                               fold=args.fold).get_dataloaders()
