...
from network.up_block_unpooling import UnetrUpBlock, UnetrBasicBlock
...
class RSSNet(nn.Module):
    ...
    def forward(self, x_in):
        ...
        feature = self.feature(hidden_states_out[3])
        dec2 = self.decoder4(feature, hidden_states_out[2])
...
if __name__ == '__main__':
    ...
    data, target = batch_data["data"], batch_data["target"]
