...
from utilities.config import default_num_processes, default_output_folder
...
def get_output_folder(dataset_name_or_id: Union[str, int], trainer_name: str = 'nnUNetTrainer',
    ...
    tmp = join(default_output_folder, maybe_convert_to_dataset_name(dataset_name_or_id),
